...
1- Convert the distribution of the species into a parameter managing the encounter probability between two species of fish : the interaction parameter. 
   ...
   The parameter reprents the number of cells where both preys i and predator j are present together divided by the number of cells where is the predator j.
...
3- Ultimately, we need to explain to osmose that the sppatial dimension has been removed. 
